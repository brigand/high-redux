(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.HighRedux = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
'use strict';
...
Object.keys(_HrStateWrapper).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _HrStateWrapper[key];
    }
  });
});
...
function makeHr(opts) {
  ...
  function reducer(_state, action) {
    var state = _state || (0, _HrStateWrapper.makeDefaultHrState)();

    var handler = actions[action.type];
    if (!handler) return state;

    var hrState = (0, _HrStateWrapper.wrapperFromState)(state);

    var res = handler(hrState, action.payload, action);

    if (!(res instanceof _HrStateWrapper.HrStateWrapper)) {
  ...
  */
  ...
  _createClass(HrQuery, [{
    ...
    */
    ...
    key: 'idProps',
    value: function idProps(id) {
      var _props;

      var name = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'data';

      var desc = this.idDesc(id);

      if (!desc) return {};

      var props = (_props = {}, _defineProperty(_props, name, desc.value), _defineProperty(_props, name + 'Error', desc.error), _defineProperty(_props, name + 'HasError', desc.hasError), _defineProperty(_props, name + 'Loading', desc.loading), _defineProperty(_props, name + 'Etc', desc.etc || {}), _props);
    ...
    */
    ...
    value: function listProps() {
      ...
      var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'items';

      var desc = this.listDesc();

      if (!desc) return {};

      var props = (_props2 = {}, _defineProperty(_props2, name, desc.value || []), _defineProperty(_props2, name + 'Error', desc.error || null), _defineProperty(_props2, name + 'HasError', desc.hasError || false), _defineProperty(_props2, name + 'Loading', desc.loading || false), _defineProperty(_props2, name + 'Etc', desc.etc || {}), _props2);
    ...
    */
    ...
    key: 'kv',
    value: function kv(key) {
      var desc = this.kvDesc(key);
      if (!desc) return null;
    ...
    */
    ...
    value: function kvProps(key) {
      ...
      var props = (_props3 = {}, _defineProperty(_props3, finalName, desc.value), _defineProperty(_props3, finalName + 'Error', desc.error), _defineProperty(_props3, finalName + 'HasError', desc.hasError), _defineProperty(_props3, finalName + 'Loading', desc.loading), _defineProperty(_props3, finalName + 'Etc', desc.etc || {}), _props3);
    ...
    */
    ...
    key: 'listDesc',
    value: function listDesc() {
      var desc = this.st.lists[t.getKey(this.path.key)];
      return desc || null;
    }
...
exports.makeDefaultHrState = makeDefaultHrState;
exports.makeHrStateDesc = makeHrStateDesc;
exports.wrapperFromState = wrapperFromState;
...
function makeHrStateDesc(value, properties) {
  return _extends({
    loading: false,
    hasError: false,
    error: null,
...
var HrStateWrapper = function () {
  /*
    Creates a HrStateWrapper instance. This is typically done for you.
  */
  function HrStateWrapper(path) {
    _classCallCheck(this, HrStateWrapper);
  ...
  _createClass(HrStateWrapper, [{
    ...
    */
    ...
    value: function getState() {
      var sw = this.root();
      var _sw$path$info = sw.path.info,
          state = _sw$path$info.state,
          ops = _sw$path$info.ops;
    ...
    */
    ...
    key: '_pushOp',
    value: function _pushOp(op, data) {
      var overrides = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

      this.path.info.ops.push(_extends({
        op: op,
        key: this.path.key,
        type: this.path.type,
...
exports.default = buildDispatcherComponent;
...
function buildDispatcherComponent(C, ops, extraOpts) {
  ...
  var DispatcherComponent = function (_React$Component) {
    ...
    function DispatcherComponent(props, context) {
      _classCallCheck(this, DispatcherComponent);

      var _this = _possibleConstructorReturn(this, (DispatcherComponent.__proto__ || Object.getPrototypeOf(DispatcherComponent)).call(this, props, context));
    ...
    _createClass(DispatcherComponent, [{
      ...
      value: function render() {
        ...
        if (key !== undefined) {
          return React.createElement(C, _extends({}, this.props, { key: key }));
        } else {
...
var _buildDispatcherComponent3 = _interopRequireDefault(_buildDispatcherComponent2);
...
var PropData = exports.PropData = function () {
  ...
  _createClass(PropData, [{
    ...
    value: function wrap(component) {
      var C = (0, _reactRedux.connect)(this._buildMapState(), this._buildMapDispatch())(component);
    ...
    */
    ...
    key: 'select',
    value: function select(propName) {
    ...
    key: 'bindAction',
    value: function bindAction(propName, getAction) {
      this.dispatchPropOps.push(new DispatchPropOp(propName, getAction));
      return this;
    }
  }, {
    key: '_makeSelector',
    value: function _makeSelector(sel) {
      return typeof sel === 'function' ? sel : function (ownProps) {
        return ownProps[sel];
      };
    }
  }, {
    ...
    */
    ...
    key: 'keyBy',
    value: function keyBy(_selector) {
      var selector = typeof _selector === 'string' ? function (ownProps) {
        return ownProps[_selector];
      } : _selector;
    ...
    key: '_buildDispatcherComponent',
    value: function _buildDispatcherComponent(C) {
      return (0, _buildDispatcherComponent3.default)(C, this.dispatchComponentOps, { computeKey: this.computeKey });
    }
    ...
    key: '_buildMapState',
    value: function _buildMapState() {
      var propOps = this.propOps;


      return function makeMapStateToProps() {
        var handlers = propOps.map(function (x) {
          return x.getHandler ? x.getHandler() : x.handler;
        });
    ...
    key: '_buildMapDispatch',
    value: function _buildMapDispatch() {
      var dispatchPropOps = this.dispatchPropOps;


      var mapDispatchToProps = {};
      for (var i = 0; i < dispatchPropOps.length; i += 1) {
        var op = dispatchPropOps[i];
